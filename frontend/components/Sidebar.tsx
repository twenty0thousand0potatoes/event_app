...
const navLinks = [
  ...
  { href: "/logout", label: "Выход", icon: "M11 16l-4-4m0 0l4-4m-4 4h14m-5 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h7a3 3 0 013 3v1" },
];

const moderatorLink = { href: "/moderator", label: "Панель модератора", icon: "M12 4v16m8-8H4" };
...
const Sidebar = ({ userRole }: SidebarProps) => {
  ...
  const linksToRender = userRole === "moderator" ? [...navLinks, moderatorLink] : navLinks;
    ...
    <>
      ...
      >
        ...
        <ul className="flex flex-col p-4 space-y-2">
          {linksToRender.map(({ href, label, icon }) => (
            <li key={href}>
              <Link
                href={href}
